...
tab.SCV <- read.table(file = "UTR_annotation/tables/SCV_UTR_PODANS.tab",
                         header = T,
                         sep = "\t")
...
write.table(x = gff.stringtie,
            file = "annotations/genome_annotation_PODANS_SCV.gff",
            sep = "\t",
            quote = F,
            row.names = F,
            col.names = F)
...
write.table(x = df.SCV.RNAseq,
            file = "UTR_annotation/tables/SCV_mRNA_PODANS.tab",
            sep = "\t",
            quote = F,
            row.names = F,
            col.names = T)
